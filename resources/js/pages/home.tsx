                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                            ...
                            <div className="flex-1">
                                <select
                                    ...
                                    onChange={(e) => setTrimestreSelecionado(Number(e.target.value))}
                                    className="w-full min-h-[48px] rounded-lg border-2 border-gray-200 px-4 py-3 font-semibold text-gray-700 transition-colors hover:border-indigo-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 bg-white"
                                >
